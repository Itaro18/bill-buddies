...
export default function Homepage(){
    ...
    return <div className="w-4/5">
        ...
        <div className=" mt-28 mb-12 sm:mt-40 sm:mb-32">
            <h1 className="text-4xl sm:text-5xl my-4">Hassle free <span className="text-red-600 ">Bill</span> splitting between <span className="text-red-600">Buddies</span></h1>
            <p className="text-2xl sm:text-3xl">Clear the bills with <span className="text-red-600">Crypto</span></p>
        </div >
